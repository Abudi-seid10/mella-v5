        ...
        <form ref={formRef} onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-white">
          ...
          <div>
            <motion.button
              ...
              className="w-full bg-rose-red hover:bg-rose-red/90 text-black px-4 py-3 rounded-full transition-all font-medium disabled:opacity-70 disabled:cursor-not-allowed border-2 border-rose-red/30 shadow-lg hover:shadow-xl"
